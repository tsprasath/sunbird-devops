...
wget https://sunbirdartifact.blob.core.windows.net/artifacts/content-plugins-artifacts.zip:release-5.2.0_RC1_c7c385c_16 -O content-plugins.zip 
...
wget https://sunbirdartifact.blob.core.windows.net/artifacts/collection-editor-artifacts.zip:release-3.3.0_a0bcde5 -O collection-editor.zip 
...
# Preview
wget https://sunbirdartifact.blob.core.windows.net/artifacts/CR_Preview_Artifacts.zip:release-3.6.0_cacebbc	 -O CR_Preview_Artifacts.zip
